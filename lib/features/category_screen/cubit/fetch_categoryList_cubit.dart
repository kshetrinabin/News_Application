...
class FetchNewsCategoryListCubit extends Cubit<CommonState> {
  final NewsRepositary repositary;
  FetchNewsCategoryListCubit({required this.repositary}) : super(CommonInitialState());

  fetchNewsCategoryList({required String categoryId}) async{
    emit(CommonLoadingState());
    final res = await repositary.fetchCategoryList(categoryId: categoryId);
    res.fold(
